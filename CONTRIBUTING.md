...
> Have you found a security issue? Please work with project maintainers so that
...
- Is it within AuthN's scope? See below.

### CHANGELOG

Please include a short sentence about the change in `CHANGELOG.md`. This simplifies release management.
